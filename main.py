...
averagePSRadialResultsFileName = os.path.join(
    resultsDirectory, "averagePSRadialResults.hdf5")

averagePSRadialFigureFileName = os.path.join(
    resultsDirectory, "averagePSRadialFigure.png")

averagePSLocalResultsFileName = os.path.join(
    resultsDirectory, "averagePSLocal.hdf5")
averagePSLocalFigureFileName = os.path.join(
    resultsDirectory, "averagePSLocal.png")

whiteningFiltersFigureFileName = os.path.join(
    resultsDirectory, "whiteningFilters.png")
whiteningFiltersResultsFileName = os.path.join(
    resultsDirectory, "whiteningFilters.hdf5")

ICResultsFileName = os.path.join(resultsDirectory, "IC.hdf5")
ICFigureFileName = os.path.join(resultsDirectory, "IC.png")

ICAActivationsResultsFileName = os.path.join(
    resultsDirectory, "ActivationsICA.hdf5")
ICAActivationsSparsenessFigureFileName = os.path.join(
    resultsDirectory, "ActivationsICA.png")
...
PSpy.makeAveragePSRadialFigure(
    np.unique(radialFreq), averagePSRadial, averagePSRadialFigureFileName)
